...
import com.joelmaciel.apigateway.api.dtos.RequestDTO;
import com.joelmaciel.apigateway.api.dtos.TokenDTO;
...
public class AuthFilter extends AbstractGatewayFilterFactory<AuthFilter.Config> {
    ...
    public static final String VALIDATE_URL = "http://auth-service/api/auth/validate?token=";
